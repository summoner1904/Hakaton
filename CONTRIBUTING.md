...
Report bugs at https://github.com/summoner1904/AdvancedCable/issues.
...
Advanced_Cabel_Plugin could always use more documentation, whether as part of the
official Advanced_Cabel_Plugin docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/summoner1904/AdvancedCable/issues.
...
Ready to contribute? Here's how to set up `AdvancedCable` for local development.

1. Fork the `AdvancedCable` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/AdvancedCable.git
    ```
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check
   https://github.com/summoner1904/AdvancedCable/actions
